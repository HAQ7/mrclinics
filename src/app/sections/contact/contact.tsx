                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <a
                                href="https://maps.app.goo.gl/oKum5KTyZRCnK3Wv9"
                                className="bg-mrclinics-primary w-min text-nowrap hover:bg-mrclinics-primary/90 text-white font-semibold py-3 px-5 rounded-full text-md transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer"
                            >
                                {t("card1.button")}
                            </a>
                        </div>
